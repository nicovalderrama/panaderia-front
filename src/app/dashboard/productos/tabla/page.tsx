        ...
        <div>
          <div className="flex justify-between mb-4">
            <div className="flex items-center ">
              <h1 className="text-2xl font-bold mr-8 text-marron-oscuro">
                Gestion de Venta
              </h1>
              <div className="flex">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center mr-2 justify-center px-4 py-2 bg-marron-oscuro text-white rounded-md hover:bg-marron-principal transition-colors"
                >
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center justify-center px-4 py-2 bg-marron-oscuro text-white rounded-md hover:bg-marron-principal transition-colors"
                >
                  <FaCartArrowDown />
                  <p className="ml-2">Procesar el pago</p>
                </motion.button>
              </div>
            </div>
          ...
          <AnimatePresence mode="wait">
            {!cartItems.length ? (
              ...
              >
                <ShoppingCart size={64} className="text-marron-oscuro mb-4" />
                <h2 className="text-2xl font-bold text-marron-oscuro mb-4">
